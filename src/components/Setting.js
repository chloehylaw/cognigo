...
export default function Setting() {
    return <div className='containerDiv'>
        <Container className='gridContainerDiv' style={{ maxWidth: "60em"}}>
     <Card className='dashSection' style={{ margin:'2em', textAlign:'center'}}>
        <Card.Title style={{fontSize:'2em', marginTop:'0.2em'}}><strong>Settings</strong></Card.Title>
        <hr style={{width: "100%"}}/>
...
<Row style={{marginBottom:'1em', marginTop:'1em'}}>
    <Col style={{marginLeft:'1em', textAlign:'left', fontSize:'130%'}}><BsFileEarmarkFontFill style={{marginRight:'1em'}}></BsFileEarmarkFontFill>Line Spacing</Col>
    <Col style={{textAlign:'right', marginRight:'1em'}}><BsArrowRight style={{fontSize:'150%'}}></BsArrowRight></Col>
</Row>
<Row style={{marginBottom:'1em', marginTop:'1em'}}>
    <Col style={{marginLeft:'1em', textAlign:'left', fontSize:'130%'}}><BsFileEarmarkFontFill style={{marginRight:'1em'}}></BsFileEarmarkFontFill>Button Sizing</Col>
    <Col style={{textAlign:'right', marginRight:'1em'}}><BsArrowRight style={{fontSize:'150%'}}></BsArrowRight></Col>
</Row>
<Row style={{marginBottom:'1em', marginTop:'1em'}}>
