...
export default function Home() {
    ...
    return <Container>
        <Row >
            <Col ><h1 style={{textAlign:'left', marginTop: "2em"}}>Welcome to CogniGo!</h1>
            <p style={{textAlign:'left'}} > Cognitive rehabilitation therapy (CRT)
                is useful for people with cognitive impairments. However, 
                it can be difficult and time-consuming for patients.
                With CogniGo we can help to make you the best you can be. 
                <Button variant="dark" size='lg' style={{marginTop: "3em"}} href='http://localhost:3000/register'>Get started now</Button></p>
            ...
            <h2 style={{textAlign:'left', marginTop:'2em'}}>How to works:</h2>
        ...
        <h2 style={{marginBottom:'1em'}}>With us, you can exercise a variety of cognitive functions daily:</h2>
        <Row>
        <Col><Card >
